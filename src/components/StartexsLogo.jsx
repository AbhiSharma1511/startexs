...
const StartexsLogo = () => {
  return (
    ...
    <div className="absolute inset-0 animate-spin-slow rounded-full border-[6px] border-transparent dark:border-t-black dark:border-b-black border-t-white border-b-white"></div>

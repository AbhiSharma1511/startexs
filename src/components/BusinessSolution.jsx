...
const BusinessSection = () => {
  return (
    <div id='service' className='w-full mt-10 md:mt-28 flex flex-col items-center bg-transparent'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-20 w-full px-8 md:px-20'>
        {services.map((service, index) => (
          ...
          >
            <img className='rounded-xl object-contain h-full' src={service.imgSrc} alt={service.title} />
            ...
            <div className='absolute bottom-0 left-0 px-6 py-4 transition-opacity duration-500 lg:opacity-50 hover:opacity-100 lg:bg-opacity-0  lg:hover:bg-black/70 bg-black/80 w-full'>
              <h2 className='pt-5 text-lg md:text-xl lg:text-2xl w-full text-center md:text-start'>{service.title}</h2>

...
const BusinessSection = () => {
  return (
    <div id="service" className='w-full mt-10 md:mt-28 flex flex-col items-center'>
      <div className='mb-10'>
      ...
      <div className='flex flex-col w-[70%] md:w-full md:flex-row gap-4 md:gap-1  justify-center md:justify-around'>
        <div className='flex flex-col items-center text-center border-gray-400 border-2 h-min rounded-xl p-3 bg-gray-400 hover:scale-110 transition-transform duration-1000 ease-out' >
